...
public interface PascalListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PascalParser#breakStatement}.
	 * @param ctx the parse tree
	 */
	void enterBreakStatement(PascalParser.BreakStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link PascalParser#breakStatement}.
	 * @param ctx the parse tree
	 */
	void exitBreakStatement(PascalParser.BreakStatementContext ctx);
	/**
